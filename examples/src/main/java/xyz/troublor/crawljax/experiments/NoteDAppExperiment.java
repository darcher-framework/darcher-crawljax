...
//        builder.setMaximumStates(0); // unlimited
        ...
        noteForm.inputField(FormInput.InputType.DYNAMIC,
                new Identification(Identification.How.xpath, "//TEXTAREA[@id='new_note']"))
                .setInputGenerator((driver, webElement, nodeElement) -> new InputValue("Note " + count.getAndIncrement()));
        inputSpec.setValuesInForm(noteForm).beforeClickElement("BUTTON").withAttribute("id", "add_new");
